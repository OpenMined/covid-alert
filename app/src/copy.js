...
export default {
  ...
  ar: {
    message: 
    ` 
                                                                                    COVID-19 اذا كان المريض (المرضى) المصابون بحالات  
                                                                             المبلغ عنها في نطاق 100 متر من موقعك الحالي خلال الـ 72
    ...
    body: (
      <>
                                                                             ...
                                                                             وا رسال إشعارًا إلى هاتفك عندما تكون قريبًا من المعرفة
                                                                                                    COVID-19 المواقع السابقة لضحايا
